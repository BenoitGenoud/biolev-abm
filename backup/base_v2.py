...
class PrimateAgent:
    def __init__(self, id, parent1=None, parent2=None):
        ...
        # Initialisation des traits héritables avec ou sans parents
        if parent1 and parent2:
            # === Stratégie héritée (génotype), avec mutation binaire === #
            ...
            self.genetic_strategy = random.choice(['cooperate', 'defect'])

        # === Phénotype : comportement flexible influencé par plasticité === #
        # La stratégie exprimée peut s'écarter du génotype avec une faible proba
        if random.random() < 0.1:  # plasticité comportementale
            self.behavior_strategy = 'cooperate' if self.genetic_strategy == 'defect' else 'defect'
        else:
            self.behavior_strategy = self.genetic_strategy

        # === Altruisme variable (trait continu hérité) === #
    ...
    def decide(self, partner):
        # === Bruit aléatoire dans la décision === #
        ...
        # === Stratégie comportementale de base === #
...
def run_simulation():
    ...
    for generation in range(N_GENERATIONS):
        ...
        # === Sélection naturelle : top 50 % se reproduisent === #
        #test
        #test2
        ...
        # === Reproduction sexuée : deux parents au hasard dans le top_half === #
        ...
        # === Suivi du taux de coopération global === #
